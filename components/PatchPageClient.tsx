...
export default function PatchPageClient({ isLocalhost }: { isLocalhost: boolean }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      <div className="bg-white rounded-lg border border-gray-200 mb-6 overflow-hidden p-4">
        <GroupedPatchTable groups={patch.groups} fixtures={fixtures} patchId={patch.id} onGroupChanged={fetchPatch} isLocalhost={isLocalhost} />
      </div>
